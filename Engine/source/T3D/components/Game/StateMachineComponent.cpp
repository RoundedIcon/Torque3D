...
void StateMachineComponent::initPersistFields()
{
   ...
   //addField("stateStartTime", TypeF32, Offset(mStateStartTime, StateMachineComponent), "The sim time of when we started this state");
   //addField("stateTime", TypeF32, Offset(mStateStartTime, StateMachineComponent), "The current amount of time we've spent in this state");
   //addField("startingState", TypeString, Offset(mStartingState, StateMachineComponent), "The current amount of time we've spent in this state");
}
