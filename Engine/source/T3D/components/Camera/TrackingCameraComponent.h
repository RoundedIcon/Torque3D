...
//-----------------------------------------------------------------------------
#ifndef _TRACKING_CAMERA_COMPONENT_H_
#define _TRACKING_CAMERA_COMPONENT_H_
...
/// 
//////////////////////////////////////////////////////////////////////////
class TrackingCameraComponent : public Component
{
   ...
   SceneObject* mTrackedObject;

public:
   TrackingCameraComponent();
   virtual ~TrackingCameraComponent();
   DECLARE_CONOBJECT(TrackingCameraComponent);
