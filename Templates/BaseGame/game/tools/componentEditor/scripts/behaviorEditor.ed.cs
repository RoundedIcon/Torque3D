...
function GuiInspectorEntityGroup::InspectObject( %this, %targetObject )
{
   ...
   /*for(%i=0; %i < %targetObject.getComponentCount(); %i++)
   {
      %compRollout = BehaviorEditor::createBehaviorRollout(%this, %targetObject.getComponentByIndex(%i));
      %this.stack.addGuiControl(%compRollout);
   }*/
